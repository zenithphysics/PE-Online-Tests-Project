...
@push('css')
    <link href="/assets/plugins/introjs/introjs.css" rel="stylesheet" />
@endpush
...
@section('content')
	...
	<div class="jumbotron text-center bg-white">
		...
		<p>
		<a class="btn btn-lg btn-primary" href="javascript:void(0);" onclick="javascript:introJs().start();">Demo</a></p>
	...
	<div class="row text-center" data-step="3" 
		...
		<!-- begin col-4 -->
		<div class="col-lg-4">
			<div class="m-b-10"><i class="fa fa-compress fa-5x text-muted"></i></div>
		...
		<!-- begin col-4 -->
		<div class="col-lg-4">
			<div class="m-b-10"><i class="fa fa-child fa-5x text-primary"></i></div>
