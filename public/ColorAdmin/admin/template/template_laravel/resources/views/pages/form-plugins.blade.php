			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-7">
				...
				<div class="panel-body panel-form">
					<form class="form-horizontal form-bordered">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Theme White</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Theme Inverse</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Theme Primary</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Theme Info</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Theme Success</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Theme Warning</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Theme Danger</label>
							<div class="col-md-8">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-9">
				...
				<div class="panel-body panel-form">
					<form class="form-horizontal form-bordered">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Visible Password</label>
							<div class="col-md-8">
		...
		<div class="col-lg-6">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-10">
				...
				<div class="panel-body panel-form">
					<form class="form-horizontal form-bordered">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Custom Color Palette</label>
							<div class="col-md-8">
								<div class="row">
									<div class="col-md-6">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-11">
				...
				<div class="panel-body panel-form">
					<form class="form-horizontal form-bordered">
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Basic Usage</label>
							<div class="col-md-8">
								<div class="input-group">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">FontAwesome Theme</label>
							<div class="col-md-8">
								<div class="input-group">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-12">
				...
				<div class="panel-body panel-form">
					<form class="form-horizontal form-bordered">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Prepend Color Picker</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">RGBA Color format</label>
							<div class="col-md-8">
								<input type="text" class="form-control" value="rgb(155,89,182,0.8)" id="colorpicker-rgba" data-color-format="rgba" />
							</div>
						</div>
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Default timepicker</label>
							<div class="col-md-8">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-15">
				...
				<div class="panel-body panel-form">
					<form class="form-horizontal form-bordered">
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Default Tags Input with Autocomplete</label>
							<div class="col-md-8">
