			...
			<div>
				...
				<div className="row">
					<div className="col-lg-3 col-md-6">
						...
						<Card inverse className="bg-gradient-black card-inverse">
							<CardBody>
					...
					<div className="col-lg-3 col-md-6">
						...
						<Card className="card-inverse bg-gradient-blue text-center">
							<CardBody>
								<blockquote className="card-blockquote">
									<p className="f-s-14 f-w-600">Make it so that <br />everything becomes your<br /> spiritual advisor</p>
									<footer className="f-s-12">Someone famous in <cite title="Source Title">Source Title</cite></footer>
								</blockquote>
							</CardBody>
						</Card>
						<Card className="card-inverse bg-gradient-teal text-center">
							<CardBody>
								<blockquote className="card-blockquote">
						...
						<Card className="card-inverse bg-gradient-black text-center">
							<CardBody>
								<blockquote className="card-blockquote">
						...
						<Card body outline color="warning" className="card-outline-warning bg-white text-center">
							<blockquote className="card-blockquote">
								<p className="f-s-14 text-inverse f-w-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
								<footer className="f-s-12">Someone famous in <cite title="Source Title">Source Title</cite></footer>
							</blockquote>
						</Card>
						
						<Card body outline color="danger" className="card-outline-danger bg-white text-center">
							<blockquote className="card-blockquote">
								<p className="f-s-14 text-inverse f-w-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
								<footer className="f-s-12">Someone famous in <cite title="Source Title">Source Title</cite></footer>
							</blockquote>
				...
				<div className="row">
					<div className="col-md-12">
						<div className="m-b-10 f-s-10 m-t-5"><b className="text-inverse">CARD GROUPS</b></div>
					...
					<div className="col-md-12">
						...
						<CardColumns>
							...
							<Card>
								<CardBody>
									<blockquote className="card-blockquote">
										...
										<footer className="text-muted f-s-12">
							...
							<Card className="card-inverse bg-gradient-purple text-center">
								<CardBody>
									<blockquote className="card-blockquote">
							...
							<Card className="card-inverse bg-black text-right">
								<CardBody>
									<blockquote className="card-blockquote">
