				...
				<div className="row">
					<div className="col-lg-8">
						...
						<TabContent activeTab={this.state.activeTab}>
							<TabPane tabId="1">
								<div className="height-sm overflow-scroll">
						...
						<Panel>
							...
							<textarea className="form-control no-rounded-corner bg-silver" rows="14" defaultValue="Enter some comment."></textarea>
							...
							<PanelFooter>
								<form>
									<div className="input-group">
										<input type="text" className="form-control bg-silver" placeholder="Enter message" />
							...
							<PanelBody className="p-t-0">
								<div className="table-responsive">
									<table className="table table-valign-middle">
										...
										<tbody>
											<tr>
												<td><label className="label label-danger">Unique Visitor</label></td>
											...
											<tr>
												<td><label className="label label-warning">Bounce Rate</label></td>
												<td>28.2%</td>
												<td>
											...
											<tr>
												<td><label className="label label-success">Total Page Views</label></td>
												<td>1,230,030</td>
												<td>
											...
											<tr>
												<td><label className="label label-primary">Avg Time On Site</label></td>
												<td>00:03:45</td>
												<td>
											...
											<tr>
												<td><label className="label label-default">% New Visits</label></td>
												<td>40.5%</td>
												<td>
											...
											<tr>
												<td><label className="label label-inverse">Return Visitors</label></td>
												<td>73.4%</td>
												<td>
